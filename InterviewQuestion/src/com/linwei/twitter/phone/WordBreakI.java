...
public class WordBreakI {
    ...
    private static boolean breakable(String s, Set<String> wordDict){
	...
	public static void main(String[] args) {
		...
		String toArray[] = new String[set.size()]; 
		String strs[] = set.toArray(toArray);
		//for(String str: toArray) System.out.println(str);
		//for(String str: strs) System.out.println(str);
		String s = new String("fohhemkkaecojceoaejkkoedkofhmohkcjmkggcmnami");
